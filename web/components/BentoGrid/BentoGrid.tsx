      ...
      `}
        >
            ...
            <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-mono text-xs text-cyber-cyan/60 uppercase tracking-widest">
                    Module Active
                </span>
            </div>

            {/* Content */}
            <h3 className="text-xl md:text-2xl font-bold mb-2 group-hover:text-cyber-cyan transition-colors">
                {title}
            </h3>
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                <div className="absolute inset-0 bg-gradient-to-t from-cyber-cyan/10 to-transparent" />
            </div>

            {/* Corner accent */}
            <div className="absolute top-4 right-4 w-8 h-8 border-t border-r border-cyber-cyan/30 group-hover:border-cyber-cyan transition-colors" />
        </motion.div>
    );
}
...
function AIBrainAnimation() {
    return (
        <div className="relative w-24 h-24">
            ...
            >
                <Brain className="w-12 h-12 text-cyber-cyan" />
            </motion.div>
...
function RadarAnimation() {
    return (
        <div className="relative w-28 h-28">
            ...
            <div className="absolute inset-[15%] rounded-full border border-cyber-cyan/30" />
            <div className="absolute inset-[30%] rounded-full border border-cyber-cyan/40" />
            <div className="absolute inset-[45%] rounded-full bg-cyber-cyan/20" />
            ...
            >
                ...
                <div
                    ...
                    style={{
                        background: "conic-gradient(from 0deg, rgba(0, 240, 255, 0.3), transparent 60deg)"
                    }}
                />
            </motion.div>
        ...
        <div className="relative w-32 h-24 flex items-center justify-center gap-3">
            {[0, 1, 2].map((i) => (
                ...
                >
                    {/* Block */}
                    <motion.div
                        className="w-10 h-10 rounded-lg border-2 border-cyber-cyan/50 bg-cyber-cyan/10 flex items-center justify-center"
                        animate={{
                    ...
                    {i < 2 && (
                        <motion.div
                            ...
                            animate={{
                                opacity: [0.3, 1, 0.3],
                                backgroundColor: ["rgba(0, 240, 255, 0.3)", "rgba(0, 240, 255, 1)", "rgba(0, 240, 255, 0.3)"],
                            }}
    ...
    return (
        <section className="py-20 px-4 md:px-8 lg:px-16">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <span className="text-mono text-cyber-cyan text-sm tracking-widest uppercase">
                        Core Systems
                    </span>
                    <h2 className="heading-section mt-4">
                        <span className="text-white">Defense </span>
                        <span className="text-cyber-cyan text-glow-cyan">Matrix</span>
                    </h2>
                </motion.div>

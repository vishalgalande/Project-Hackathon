...
class AboutPage extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildProjectInfoRow(Icons.calendar_month,
                      'Built for TechSprint - GDG 2026 Hacks'),
                  _buildProjectInfoRow(
                      Icons.school, 'Manipal University Jaipur'),
            ...
            ElevatedButton.icon(
              ...
              onPressed: () => launchUrl(Uri.parse(
                  'https://github.com/vishalgalande/Project-Hackathon')), // Using main repo link provided or derived
            ),
            ...
            const SizedBox(height: 32),
            Center(
              child: Text('Made with ❤️ by Team Strawhats',
            ...
            children: badges
                .map((b) => Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(b.icon,
                              size: 16, color: const Color(0xFF5865F2)),
  ...
  Widget _buildTeamMember({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(
            0xFF1A1A1A), // White card in screenshot, but we are dark theme. Keep consistent.

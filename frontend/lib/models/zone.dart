...
class MockZones {
  static const List<Zone> allIndiaZones = [
    ...
    Zone(
      ...
      lightingLevel: 95,
      recentIncidents: 0,
      description: 'Jaipur International Airport. Well-secured area.',
      warnings: [],
    ),
    Zone(
      id: 'jai_5',
      ...
      lightingLevel: 70,
      recentIncidents: 4,
      description: 'Major railway hub. Crowded during peak hours.',
      warnings: ['Watch belongings', 'Beware of touts'],
    ),
    Zone(
      id: 'jai_6',
      name: 'Sanganer',
      ...
      lightingLevel: 75,
      recentIncidents: 2,
      description: 'Industrial area near airport. Famous for block printing.',
      warnings: ['Traffic congestion'],
    ),
    // --- Manipal University Jaipur Area ---
    Zone(
      id: 'jai_muj_1',
      ...
      lightingLevel: 95,
      recentIncidents: 0,
      description: 'University campus. Well-secured with 24/7 security.',
      warnings: [],
    ),
    Zone(
      id: 'jai_muj_2',
      ...
      lightingLevel: 80,
      recentIncidents: 1,
      description: 'Village near Manipal University. Residential area.',
      warnings: [],
    ),
    Zone(
      id: 'jai_muj_3',
      ...
      lightingLevel: 65,
      recentIncidents: 3,
      description: 'Town near MUJ. Famous for hand block printing.',
      warnings: ['Limited street lighting at night'],
    ),
    Zone(
      id: 'jai_muj_4',
      name: 'Mahapura',
    ...
    Zone(
      ...
      lightingLevel: 70,
      recentIncidents: 2,
      description: 'Highway junction on Jaipur-Ajmer Expressway.',
      warnings: ['Heavy traffic', 'Drive carefully'],
    ),
    // --- Additional Jaipur Zones ---
    Zone(
      id: 'jai_7',
      name: 'C-Scheme',
      type: 'safe',
    ...
    Zone(
      ...
      lightingLevel: 88,
      recentIncidents: 1,
      description: 'Large residential colony with good amenities.',
      warnings: [],
    ),
    Zone(
      id: 'jai_9',
      ...
      lightingLevel: 85,
      recentIncidents: 2,
      description: 'One of the largest residential areas in Asia.',
      warnings: [],
    ),
    Zone(
      id: 'jai_10',
      ...
      lightingLevel: 75,
      recentIncidents: 3,
      description: 'Commercial market area. Busy during day.',
      warnings: ['Crowded streets', 'Watch belongings'],
    ),
    Zone(
      id: 'jai_11',
      name: 'Sodala',
    ...
    Zone(
      ...
      lightingLevel: 90,
      recentIncidents: 1,
      description: 'Government offices and residential area.',
      warnings: [],
    ),
    Zone(
      id: 'jai_14',
    ...
    Zone(
      ...
      lightingLevel: 75,
      recentIncidents: 3,
      description: 'Older residential area with mixed commercial.',
      warnings: ['Some poorly lit streets'],
    ),
    Zone(
      id: 'jai_16',
      name: 'Tonk Road',
      ...
      lightingLevel: 70,
      recentIncidents: 4,
      description: 'Major commercial highway with heavy traffic.',
      warnings: ['Heavy traffic', 'Accidents common'],
    ),
    Zone(
      id: 'jai_17',
      name: 'Sitapura Industrial',
      type: 'caution',
      centerLat: 26.7850,
      centerLng: 75.8400,
      radius: 600,
      ...
      lightingLevel: 68,
      recentIncidents: 2,
      description: 'Major industrial area south of city.',
      warnings: ['Limited public transport at night'],
    ),
    Zone(
      id: 'jai_18',
      name: 'Pratap Nagar',
    ...
    Zone(
      ...
      lightingLevel: 86,
      recentIncidents: 1,
      description: 'Middle-class residential neighborhood.',
      warnings: [],
    ),
    Zone(
      id: 'jai_20',
      ...
      lightingLevel: 88,
      recentIncidents: 1,
      description: 'Planned township north of the city.',
      warnings: [],
    ),
    Zone(
      id: 'jai_21',
      ...
      lightingLevel: 65,
      recentIncidents: 4,
      description: 'Historic Amber Fort area. Tourist destination.',
      warnings: ['Tourist scams', 'Watch valuables'],
    ),

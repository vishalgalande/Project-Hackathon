...
class MockZones {
  static const List<Zone> allIndiaZones = [
    ...
    // --- MANIPAL UNIVERSITY & BAGRU REGION (DANGER/CAUTION) ---
    Zone(
      id: 'jai_muj_1',
      name: 'Manipal University Main Gate',
      type: 'danger',
      centerLat: 26.8430,
      centerLng: 75.5680,
      radius: 600,
      ...
      lightingLevel: 40,
      recentIncidents: 15,
      description: 'High-speed highway interaction. Frequent accidents reported. (Source: Mock Data)',
      warnings: ['Highway Traffic', 'Accident Prone'],
      negativeFeedbackCount: 18,
    ),
    Zone(
      id: 'jai_muj_2',
      ...
      lightingLevel: 35,
      recentIncidents: 3,
      description: 'Local village settlement. Poor street lighting. (Source: Mock Data)',
      warnings: ['Poor Lighting', 'Stray Animals'],
    ),
    Zone(
      id: 'jai_bagru_1',
      name: 'Bagru Industrial Area',
      type: 'danger',
      centerLat: 26.8105,
      centerLng: 75.5484,
      radius: 800,
      ...
      lightingLevel: 40,
      recentIncidents: 8,
      description: 'Industrial hub with heavy trucks. Pollution and traffic risks. (Source: Mock Data)',
      warnings: ['Heavy Trucks', 'Industrial Waste'],
    ...
    Zone(
      ...
      lightingLevel: 60,
      recentIncidents: 2,
      description: 'Historical town area. Narrow lanes. (Source: Mock Data)',
      warnings: ['Narrow Lanes'],
    ),
    ...
    Zone(
      ...
      lightingLevel: 60,
      recentIncidents: 5,
      description: 'Major tourist attraction. Scams and touts common. (Source: Mock Data)',
      warnings: ['Touts Active', 'Steep Slope'],
    ),
    Zone(
      id: 'jai_tour_2',
      name: 'Nahargarh Fort',
      ...
      lightingLevel: 20,
      recentIncidents: 8,
      description: 'Winding roads with no barriers. Drinking spots at night. (Source: Mock Data)',
      warnings: ['Dangerous Roads', 'Avoid at Night'],
      negativeFeedbackCount: 8,
    ),
    Zone(
      id: 'jai_tour_3',
      ...
      lightingLevel: 70,
      recentIncidents: 0,
      description: 'Well-guarded fort complex. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_tour_4',
      ...
      lightingLevel: 65,
      recentIncidents: 3,
      description: 'Lakeside promenade. Parking scams reported. (Source: Mock Data)',
      warnings: ['Tourist Scams'],
    ),
    Zone(
      id: 'jai_tour_5',
      name: 'Hawa Mahal',
      ...
      lightingLevel: 80,
      recentIncidents: 6,
      description: 'Busy market intersection. Pickpockets active. (Source: Mock Data)',
      warnings: ['Pickpockets', 'Crowded'],
    ),
    Zone(
      id: 'jai_tour_6',
      ...
      lightingLevel: 90,
      recentIncidents: 1,
      description: 'High security tourist zone. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_tour_7',
      ...
      lightingLevel: 95,
      recentIncidents: 0,
      description: 'Central museum. Well lit and patrolled. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_tour_8',
      ...
      lightingLevel: 30,
      recentIncidents: 4,
      description: 'Monkey temple. Aggressive animals and uneven paths. (Source: Mock Data)',
      warnings: ['Wild Animals', 'Uneven Terrain'],
    ),
    ...
    Zone(
      ...
      lightingLevel: 60,
      recentIncidents: 25,
      description: 'Central bus terminal. High theft risk. (Source: Mock Data)',
      warnings: ['Pickpockets', 'Touts'],
    ...
    Zone(
      ...
      lightingLevel: 55,
      recentIncidents: 18,
      description: 'Main railway station. Crowded and chaotic. (Source: Mock Data)',
      warnings: ['Luggage Theft', 'Touts'],
      negativeFeedbackCount: 15,
    ),
    Zone(
      id: 'jai_trans_3',
      ...
      lightingLevel: 70,
      recentIncidents: 5,
      description: 'Secondary station. Less crowded but isolated at night. (Source: Mock Data)',
    ...
    Zone(
      ...
      lightingLevel: 100,
      recentIncidents: 0,
      description: 'International airport. High security zone. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_trans_5',
      ...
      lightingLevel: 45,
      recentIncidents: 10,
      description: 'Truck terminal area. Heavy pollution and unsafe at night. (Source: Mock Data)',
      warnings: ['Heavy Trucks', 'Unsafe at Night'],
    ...
    Zone(
      ...
      lightingLevel: 70,
      recentIncidents: 12,
      description: 'Traditional market. Very high pickpocket density. (Source: Mock Data)',
      warnings: ['Pickpockets', 'Crowded'],
      negativeFeedbackCount: 10,
    ),
    Zone(
      ...
      lightingLevel: 75,
      recentIncidents: 8,
      description: 'Jewelry market. Traffic congestion. (Source: Mock Data)',
      warnings: ['Traffic Jam', 'Crowded'],
    ),
    Zone(
      id: 'jai_mkt_3',
      name: 'Tripolia Bazar',
      ...
      lightingLevel: 70,
      recentIncidents: 5,
      description: 'Busy hardware and utensil market. (Source: Mock Data)',
      warnings: ['Traffic'],
    ),
    Zone(
      id: 'jai_mkt_4',
      ...
      lightingLevel: 75,
      recentIncidents: 4,
      description: 'Books and stationery market. (Source: Mock Data)',
      warnings: ['Crowded'],
    ),
    Zone(
      id: 'jai_mkt_5',
      ...
      lightingLevel: 85,
      recentIncidents: 6,
      description: 'Popular food street. Heavy evening traffic. (Source: Mock Data)',
      warnings: ['Traffic Congestion'],
    ),
    Zone(
      id: 'jai_mkt_6',
      ...
      lightingLevel: 98,
      recentIncidents: 1,
      description: 'Premium mall. Private security. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_mkt_7',
      ...
      lightingLevel: 80,
      recentIncidents: 5,
      description: 'Youth hangout spot. Occasional brawls. (Source: Mock Data)',
      warnings: ['Rowdy Crowds'],
    ),
    Zone(
      id: 'jai_mkt_8',
      name: 'M.I. Road',
      ...
      lightingLevel: 90,
      recentIncidents: 8,
      description: 'Main arterial road. Speeding vehicles. (Source: Mock Data)',
      warnings: ['Speeding Vehicles'],
    ),
    Zone(
      id: 'jai_mkt_9',
      name: 'Chandpole',
      ...
      lightingLevel: 60,
      recentIncidents: 10,
      description: 'Market entry point. Congested and chaotic. (Source: Mock Data)',
      warnings: ['Chaos', 'Theft'],
      negativeFeedbackCount: 8,
    ),
    Zone(
      id: 'jai_mkt_10',
      ...
      lightingLevel: 50,
      recentIncidents: 4,
      description: 'Wholesale vegetable market. Early morning rush. (Source: Mock Data)',
      warnings: ['Trucks', 'Crowds'],
    ),
    ...
    Zone(
      ...
      lightingLevel: 92,
      recentIncidents: 1,
      description: 'Upscale residential and office area. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_res_2',
      ...
      lightingLevel: 90,
      recentIncidents: 0,
      description: 'VIP residential area. High police presence. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_res_3',
      ...
      lightingLevel: 88,
      recentIncidents: 2,
      description: 'Wealthy residential suburb. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_res_4',
      ...
      lightingLevel: 85,
      recentIncidents: 3,
      description: 'Largest residential colony. Generally safe. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_res_5',
      ...
      lightingLevel: 90,
      recentIncidents: 2,
      description: 'Modern residential sector. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_res_6',
      ...
      lightingLevel: 60,
      recentIncidents: 5,
      description: 'Developing area. Isolated patches at night. (Source: Mock Data)',
      warnings: ['Construction', 'Isolated'],
    ),
    Zone(
      id: 'jai_res_7',
      ...
      lightingLevel: 50,
      recentIncidents: 6,
      description: 'Industrial zone. Heavy vehicle movement. (Source: Mock Data)',
      warnings: ['Industrial', 'Pollution'],
    ),
    Zone(
      id: 'jai_res_8',
      name: 'Pratap Nagar',
      ...
      lightingLevel: 80,
      recentIncidents: 2,
      description: 'Housing board colony. Quiet area. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_res_9',
      ...
      lightingLevel: 65,
      recentIncidents: 5,
      description: 'Dense residential and industrial mix. Traffic bottlenecks. (Source: Mock Data)',
      warnings: ['Traffic'],
    ),
    Zone(
      id: 'jai_res_10',
      ...
      lightingLevel: 70,
      recentIncidents: 4,
      description: 'Old residential colony. (Source: Mock Data)',
      warnings: [],
    ),
    ...
    Zone(
      ...
      lightingLevel: 80,
      recentIncidents: 3,
      description: 'University campus. Occasional student unrest. (Source: Mock Data)',
      warnings: ['Protests'],
    ),
    Zone(
      id: 'jai_edu_2',
      ...
      lightingLevel: 90,
      recentIncidents: 0,
      description: 'Technical institute. Secure campus. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_edu_3',
      ...
      lightingLevel: 85,
      recentIncidents: 1,
      description: 'Private university campus. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_edu_4',
      ...
      lightingLevel: 88,
      recentIncidents: 0,
      description: 'Engineering college area. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_edu_5',
      ...
      lightingLevel: 90,
      recentIncidents: 0,
      description: 'Secure university campus. (Source: Mock Data)',
      warnings: [],
    ),
    ...
    Zone(
      ...
      lightingLevel: 75,
      recentIncidents: 8,
      description: 'Traffic chokepoint. High accident risk. (Source: Mock Data)',
      warnings: ['Accidents', 'Traffic'],
      negativeFeedbackCount: 8,
    ),
    Zone(
      id: 'jai_int_2',
      name: '200 Feet Bypass',
      type: 'danger',
      centerLat: 26.8900,
      centerLng: 75.7200,
      radius: 800,
      ...
      lightingLevel: 45,
      recentIncidents: 20,
      description: 'Major highway junction. Fast moving traffic. (Source: Mock Data)',
      warnings: ['High Speed', 'Accidents'],
      negativeFeedbackCount: 15,
    ),
    Zone(
      id: 'jai_int_3',
      ...
      lightingLevel: 95,
      recentIncidents: 1,
      description: 'Prestigious hotel area. Well managed. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_int_4',
      ...
      lightingLevel: 95,
      recentIncidents: 0,
      description: 'Iconic roundabout. Popular evening hangoug. (Source: Mock Data)',
      warnings: [],
    ),
    Zone(
      id: 'jai_int_5',
      ...
      lightingLevel: 85,
      recentIncidents: 7,
      description: 'Busy arterial road. (Source: Mock Data)',
      warnings: ['Heavy Traffic'],
    ),
    Zone(
      id: 'jai_int_6',
      ...
      lightingLevel: 50,
      recentIncidents: 11,
      description: 'Highway exit. Speeding trucks. (Source: Mock Data)',
      warnings: ['Accident Prone'],
      negativeFeedbackCount: 9,
    ),
    Zone(
      id: 'jai_int_7',
      name: 'Delhi Road (Highway)',
      type: 'danger',
      centerLat: 27.0000,
      centerLng: 75.8800,
      radius: 1000,
      ...
      lightingLevel: 40,
      recentIncidents: 14,
      description: 'Highway towards Delhi. Limited services at night. (Source: Mock Data)',
      warnings: ['Highway Robbery Risk'],
      negativeFeedbackCount: 10,
    ),
    Zone(
      id: 'jai_int_8',
      ...
      lightingLevel: 65,
      recentIncidents: 6,
      description: 'Busy intersection. (Source: Mock Data)',
      warnings: ['Traffic'],
    ),
